...
urlpatterns = [
    ...
    path('delete_voter/<str:voter_id>', AdminViews.delete_voter, name="delete_voter"),
    path('delete_committee/<str:committee_id>', AdminViews.delete_committee, name="delete_committee"),
    path('delete_candidate/<str:candidate_id>', AdminViews.delete_candidate, name="delete_candidate"),
